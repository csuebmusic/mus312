...
Part 3, chromatic harmony: applied chords, the five applied dominants of C major as root-position triads; quality informs function, reading an A major triad inside a progression; applied leading-tone chords, the five fully diminished sevenths of C major; function and applied chords, embedded phrase models and extended tonicization with the jazz ii–V–I filling the dominant space, and the prolongation map redrawn with a mediant column and applied dominants listed in the mediant, pre-dominant, and dominant.

## next

Part 3 continues: modulation and closely related keys, Laitz 148–152; modal mixture, 163–171; chromatic modulation, 171–182; Neapolitan and augmented sixth, 183–196.

Skipped: the chromatic sequences, Laitz 144–147, and the sequence as a modulating device, 153–155.

Open: whether part 3 stays in `tools/harmony-review.html` or becomes a second file. The file is 3813 lines.
